...
\renewcommand{\itemmarker}{{\small\textbullet}}
  ...
  \personalinfo{%
    ...
    \begin{itemize}
      ...
      \item Drove and took ownership of quality initiatives for AI-based products, designing specialized test strategies for ML-powered features, including accuracy validation across diverse user scenarios, edge case identification, and localization quality assurance across multiple languages.
    \end{itemize}
